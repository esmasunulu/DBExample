...
namespace newtry
{
    public partial class Form1 : Form
    {
        ...
        void MusteriGetir()
        {
            baglanti= new SqlConnection("server=DESKTOP-BLH736A;Initial Catalog=ticaret1;Integrated Security=SSPI");
            baglanti.Open();
        ...
        {
            string sorgu = "INSERT INTO musteri(ad,soyadı,dtarih,tel) VALUES (@ad,@soyadı,@dtarih,@tel)";
        ...
        {
            string sorgu = "UPDATE musteri SET ad=@ad,soyadı=@soyadı,dtarih=@dtarih,tel=@tel WHERE mno=@mno";
            komut= new SqlCommand(sorgu, baglanti);
            komut.Parameters.AddWithValue("@mno", Convert.ToInt32(txtNo.Text));
            komut.Parameters.AddWithValue("@ad", txtAd.Text);
            komut.Parameters.AddWithValue("@soyadı", txtSoyad.Text);
